...
CUDA_VISIBLE_DEVICES=0   python -u ./src/script/generate_synthesis.py --ppg2mel_model  ${ppg2mel_model} --waveglow_model $waveglow_model  --teacher_utterance_path ${teacher_utterance_path}  --output_dir ${output_dir}  --extract_mel True  --hparams ${hparams} 
